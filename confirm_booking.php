            ...
            <form action="pay_now.php" method="POST" id="booking_form">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input id = "phone" name="phonenum" type="number"  class="form-control shadow-none" placeholder = "Your phone" required>
                </div>
                <div class="col-md-12 mb-3">
                  <label for = "address" class="form-label">Address</label>
                  <textarea id = "address" name="address" class="form-control shadow-none" rows="1" placeholder = "Your address" required></textarea>
                </div>
                <div class="col-md-6 mb-3">
